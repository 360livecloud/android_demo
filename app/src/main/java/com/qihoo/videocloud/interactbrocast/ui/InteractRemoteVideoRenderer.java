...
public class InteractRemoteVideoRenderer implements Choreographer.FrameCallback, QHVCInteractiveRemoteVideoRenderCallback,
        TextureView.SurfaceTextureListener, SurfaceHolder.Callback {
    private static final String TAG = "HostinRemoteVideoRenderer";
    ...
    public final int init() {
        mThread = new HandlerThread("HostinRemoteVideoRenderer" + hashCode());
        mThread.start();
        ...
        mHandler.post(new Runnable() {
            ...
            public void run() {
                ...
                Choreographer.getInstance().postFrameCallback(InteractRemoteVideoRenderer.this);
                mIsRunning = true;
    ...
    public int setRendererView(TextureView view) {
        ...
        mHandler.post(new Runnable() {
            ...
            public void run() {
                ...
                mTextureView = temp;
                if (mTextureView != null) {
                    mTextureView.setSurfaceTextureListener(InteractRemoteVideoRenderer.this);
                }
            }
        });
        ...
        mHandler.post(new Runnable() {
            ...
            public void run() {
                if (mSurfaceView != null) {
                    ...
                    mSurfaceView.getHolder().removeCallback(InteractRemoteVideoRenderer.this);
                }

                mSurfaceView = temp;
                if (mSurfaceView != null) {
                    mSurfaceView.getHolder().addCallback(InteractRemoteVideoRenderer.this);
                }
            }
        });
    ...
    private static EGLContext createEglContext(
        ...
        synchronized (InteractRemoteVideoRenderer.lock) {
    ...
    @Override
    public void queueInputBuffer(int bufferIndex, String uid, int width, int height, int stride) {
        if (bufferIndex == -1) {
            return;
        }
