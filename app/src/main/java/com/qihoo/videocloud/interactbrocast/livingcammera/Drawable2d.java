...
public class Drawable2d {
    ...
    private static final float FULL_RECTANGLE_TEX_COORDS_ENCODE[] = {
            //            1.0f, 1.0f,      // 3 top right
            //            0.0f, 1.0f,     // 2 top left
            //            1.0f, 0.0f,     // 1 bottom right
            //            0.0f, 0.0f     // 0 bottom left
    ...
    private static final FloatBuffer FULL_RECTANGLE_TEX_BUF_FOR_ENCODE = GlUtil.createFloatBuffer(FULL_RECTANGLE_TEX_COORDS_ENCODE);
    private static final FloatBuffer FULL_RECTANGLE_TEX_MIRRORBUF = GlUtil.createFloatBuffer(FULL_RECTANGLE_TEX_MIRRO_COORDS);

    private FloatBuffer mVertexArray;
    private FloatBuffer mTexCoordArray;
    private FloatBuffer mTexMirroCoordArray;
    private FloatBuffer mTexCoordArrayForEncode; //ian add
    ...
    public Drawable2d(Prefab shape) {
        switch (shape) {
            ...
            case FULL_RECTANGLE:
                ...
                mTexCoordArrayForEncode = FULL_RECTANGLE_TEX_BUF_FOR_ENCODE;
    ...
    public FloatBuffer getTexCoordArrayForEncode() {
        return mTexCoordArrayForEncode;
    }
